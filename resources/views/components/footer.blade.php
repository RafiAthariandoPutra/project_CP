    ...
    <div class="py-[60px] xl:pb-[100px] xl:pt-[130px]">
        <div class="overflow-hidden">
            ...
            <div class="footer-text-slider flex w-full items-center gap-x-[30px] whitespace-nowrap">
                <!-- Footer Slide Item  -->
                <img src="assets/img/th-1/footer-text-slider-icon.svg" alt="footer-text-slider-icon" width="60"
    ...
    <div class="global-container">
        ...
        <div
            ...
            <div class="flex flex-col gap-y-6">
                <a class='inline-block' href='/'><img src="assets/img/th-1/logo.png" alt="logo" width="96"
                        height="24" /></a>
                <p>
            ...
            <div class="flex flex-col gap-y-6">
                ...
                <ul class="flex flex-col gap-y-[10px] capitalize">
                    <li>
                        <a class='transition-all duration-300 ease-linear hover:text-colorOrangyRed'
                            href='/'>Home</a>
                    </li>
                    <li>
                        <a class='transition-all duration-300 ease-linear hover:text-colorOrangyRed'
            ...
            <div class="flex flex-col gap-y-6">
                ...
                <ul class="flex flex-col gap-y-[10px] capitalize">
                    ...
                    <li>
                        <a class='transition-all duration-300 ease-linear hover:text-colorOrangyRed'
                            href='/error-404'>404 Not
                            found</a>
                    </li>
                    <li>
                        <a class='transition-all duration-300 ease-linear hover:text-colorOrangyRed'
                            href='/reset-password'>Password
                            Reset</a>
                    </li>
                </ul>
            </div>
