            ...
            <div class="flex items-center w-full max-w-md px-6 mx-auto lg:w-2/6">
                <div class="flex-1">
                    <div class="text-center">
                        ...
                        <p class="mt-3 text-gray-500 dark:text-gray-300">Register your account</p>
                    </div>
                    ...
                    <div class="mt-8">
                        <form method="POST" action="{{ route('register') }}">
                          ...
                          <div class="grid gap-y-4">
                            ...
                            <div class="flex items-center">
                              <div class="flex">
                                <input id="remember-me"  type="checkbox" class="shrink-0 mt-0.5 border-gray-200 rounded text-blue-600 focus:ring-blue-500 dark:bg-neutral-800 dark:border-neutral-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800">
                              </div>
                              <div class="ms-3">
                                <label for="remember-me" class="text-sm dark:text-white">I accept the <a class="text-blue-600 decoration-2 hover:underline focus:outline-none focus:underline font-medium dark:text-blue-500" href="#">Terms and Conditions</a></label>
                              </div>
                            ...
                            <!-- End Checkbox -->
                            <input type="hidden" name="role" value="socialAdmin">
