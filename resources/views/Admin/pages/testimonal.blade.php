                    ...
                    <div class="flex w-full flex-col gap-4 p-4">
                        ...
                        <div class="p-4 w-full">
                            <label class="block mt-4 text-sm">
                                <span class="text-slate-600 ">Client Image</span>
                                <div class="flex items-center justify-center w-full">
                                    <label for="dropzone-file"
                                        ...
                                        <img id="img-preview" class="w-64 rounded-full h-64 object-cover hidden">
                                        ...
                                        <input id="dropzone-file" name="client_image" onchange="previewImage()"
                                            id="image imgInp" value="{{ old('client_image') }}" type="file"
                                            class="hidden image " />
                                        @error('client_image')
                                            <p class="text-red-500 text-xs mt-1">
                                                {{ $massage }}
